...
function Properties({ properties, loading }: { properties: Array<{ id: string; title: string; location: string; status: string; priceLabel: string; updatedAt: Date; media: DashboardMedia[] }>; loading: boolean }) {
  ...
  const [imageUrls, setImageUrls] = useState("/assets/kaba/hero-dakar.webp");
  ...
  const resetForm = () => { setShowForm(false); setEditingId(null); setTitle(""); setLocation(""); setPriceLabel(""); setImageUrls("/assets/kaba/hero-dakar.webp"); setVideoUrl(""); setUploadedMedia([]); setUploadMessage(""); };
