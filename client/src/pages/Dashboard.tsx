...
function Properties({ properties, loading }: { properties: Array<{ id: string; title: string; location: string; status: string; priceLabel: string; updatedAt: Date; media: DashboardMedia[] }>; loading: boolean }) {
  ...
  const resetForm = () => { setShowForm(false); setEditingId(null); setTitle(""); setLocation(""); setPriceLabel(""); setImageUrls("/manus-storage/kaba-hero-dakar_28cefd79.jpg"); setVideoUrl(""); setUploadedMedia([]); setUploadMessage(""); };
