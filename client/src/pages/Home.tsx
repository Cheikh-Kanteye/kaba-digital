...
const properties = [
  {
    ...
    image: "/assets/kaba/property-ngor.webp",
    tag: "Sélection Kaba",
    media: ["/assets/kaba/property-ngor.webp", heroImage, "/assets/kaba/land-dakar.webp"],
  ...
  },
  {
    ...
    image: "/assets/kaba/property-almadies.webp",
    tag: "À découvrir",
    media: ["/assets/kaba/property-almadies.webp", "/assets/kaba/property-ngor.webp", heroImage],
    video: "https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4",
  },
  {
    number: "03",
    ...
    price: "Sur demande",
    image: "/assets/kaba/land-dakar.webp",
    tag: "Projet & investissement",
    media: ["/assets/kaba/land-dakar.webp", heroImage, "/assets/kaba/property-ngor.webp"],
    video: "https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4",
  },
  {
    number: "04",
    type: "Villa",
    title: "Le patio comme pièce centrale",
    location: "Ngor · Dakar",
    price: "1 200 000 FCFA / mois",
    image: heroImage,
    tag: "Adresse rare",
    media: [heroImage, "/assets/kaba/property-almadies.webp", "/assets/kaba/land-dakar.webp"],
    video: "https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4",
  },
  {
    number: "05",
    ...
    media: ["/assets/kaba/property-almadies.webp", heroImage, "/assets/kaba/property-ngor.webp"],
    video: "https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4",
  },
  {
    number: "06",
    ...
    image: "/assets/kaba/property-ngor.webp",
    tag: "Vue ouverte",
    media: ["/assets/kaba/property-ngor.webp", "/assets/kaba/land-dakar.webp", heroImage],
    video: "https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4",
  },
];
...
export default function Home() {
  ...
  return (
    <main className="kaba-site" ref={pageRef}>
      ...
      <footer className="site-footer"><div className="footer-brand"><img src={monogram} alt="" /><span>Kaba</span><p>L’immobilier, regardé autrement.<br />Dakar · Sénégal</p></div><div className="footer-column"><p className="footer-label">Explorer</p><a href="/selection">La sélection</a><a href="#approche">Notre approche</a><a href="#services">Services</a></div><div className="footer-column"><p className="footer-label">Contact</p><a href="mailto:kaba@gmail.com">kaba@gmail.com</a><a href="tel:+221766418810">+221 76 641 88 10</a><span className="footer-link-muted">Instagram — bientôt disponible</span></div><div className="footer-bottom"><span>© 2026 Kaba, Inc.</span><span>Cité Fadia, Dakar</span><span>Mentions légales</span><span>Données personnelles</span></div></footer>
      <a className="floating-filter" href="/selection" aria-label="Ouvrir la sélection et ses filtres"><SlidersHorizontal size={16} /> Filtrer les biens</a>
    </main>
  );
}
